...
import { Loader2, Eye, ArrowLeft, X, MessageCircle, Bot, Send } from 'lucide-react';
      ...
      <div className="container mx-auto px-4 py-8">
        ...
        {invoiceDetails && (
          <div className="bg-white rounded-xl shadow-sm border border-gray-200 p-6 mb-8">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-8">
              <div className="space-y-4">
                ...
                <div className="bg-red-50 rounded-lg p-4">
                  ...
                  <div className="text-red-600">
                    <p className="font-medium">{invoiceDetails.billed_to_company}</p>
                    <p className="whitespace-pre-line">{invoiceDetails.billed_to_address}</p>
                  </div>
                </div>
              </div>
              <div className="bg-red-50 rounded-lg p-4">
                ...
                <div className="space-y-2 text-red-600">
                  ...
                  <div className="flex justify-between">
                    ...
                    <span className="font-medium">{formatDate(invoiceDetails.invoice_date)}</span>
                  </div>
                  <div className="flex justify-between">
                    <span>Due Date:</span>
            ...
            {/* Tax Details */}
            {invoiceDetails.tax_details.length > 0 && invoiceDetails.tax_details[0].tax_type !== 'N/A' && (
              <div className="mt-8">
                  ...
                  {invoiceDetails.tax_details.map((tax, index) => (
                    <div key={index} className="bg-red-50 rounded-lg p-4">
                      <div className="flex justify-between items-center mb-2">
                        ...
                        <span className="text-red-800">{tax.tax_rate}%</span>
                      </div>
            ...
            <div className="flex-1 overflow-y-auto p-4 space-y-4" ref={chatContainerRef}>
              {chatHistory.map((msg, index) => (
                ...
                >
                  ...
                  >
                    {msg.type === 'assistant' && searchResults?.explanation ? (
